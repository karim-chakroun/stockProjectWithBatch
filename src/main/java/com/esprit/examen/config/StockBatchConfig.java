...
@Configuration
/*3. Activer le traitement par Batch*/
/*toDo5 batch*/
@EnableBatchProcessing
@EnableScheduling
public class StockBatchConfig {

	/*4. Création des variables de notre batch : nom fichier (voir /src/main/resources,
	...
	private String names = "libelle,qte,dateAjout,qteMin,etat";
